                    ...
                    <tbody class="request-table__tbody">
                        @foreach ($requests as $req)
                            <tr class="request-table__tr">
                                ...
                                <td class="request-table__td">{{ $req->user->name ?? '-' }}</td>

                                <td class="request-table__td">
                                    {{ optional($req->attendance)->work_date ? \Carbon\Carbon::parse($req->attendance->work_date)->format('Y/m/d') : '-' }}
                                </td>
                                ...
                                <td class="request-table__td">
                                    {{-- 承認画面へ --}}
                                    <a class="request-table__detail" href="{{ route('admin.request.approveForm', $req) }}">
                                        詳細
                                    </a>
                                </td>
                            </tr>
